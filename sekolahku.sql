...
INSERT INTO `aset_tanah` (`id`, `npsn`, `nama_sekolah`, `no_persil`, `kepemilikan`, `atasnama_sertifikat`, `status_tanah`, `luas_tanah`, `no_sertifikat`, `tgl_sertifikat`, `thn_perolehan`, `harga_perolehan`, `asal_usul`, `unit`, `letak`, `peruntukan`) VALUES
(1, 20401013, 'SMP 1 Depok', '279 P.I.', 'Yayasan', 'S.SOEBAGYO', 'SHM', 2060, 'AA 413100', '1988-02-05', 1990, 618, 'TANAH WAKAF', NULL, 'STAN, MAGUWOHARJO,DEPOK, SLEMAN\r\n', 'SMP 1 DEPOK');
